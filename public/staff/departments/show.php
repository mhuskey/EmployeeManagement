          ...
          <div class="container min-vh-100">
            <div class="row">
              <div class="col-sm-10 offset-sm-1 text-center align-middle">
                ...
                <br />
                <!-- Delete & Edit Buttons -->
                <a href="<?php echo url_for('/staff/departments/delete.php?id=' . h(u($department['id']))); ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                <a href="<?php echo url_for('/staff/departments/edit.php?id=' . h(u($department['id']))); ?>"><button type="button" class="btn btn-primary">Edit</button></a>
                  ...
                  <table class="table table-striped table-bordered table-hover">
                    ...
                    <tbody>
                      <?php while ($profile = mysqli_fetch_assoc($active_profile_set)) { ?>
                        <tr>
                          <td class="align-middle"><?php echo h($profile['id']); ?></td>
                          <td class="align-middle"><?php echo h($profile['first_name']); ?></td>
                          <td class="align-middle"><?php echo h($profile['last_name']); ?></td>
                          <td><a href="<?php echo url_for('/staff/profiles/show.php?id=' . h(u($profile['id']))); ?>"><button type="button" class="btn btn-info no-margin">View</button></a></td>
                          <td><a href="<?php echo url_for('/staff/profiles/edit.php?id=' . h(u($profile['id']))); ?>"><button type="button" class="btn btn-primary no-margin">Edit</button></a></td>
                          <td><a href="<?php echo url_for('/staff/profiles/delete.php?id=' . h(u($profile['id']))); ?>"><button type="button" class="btn btn-danger no-margin">Delete</button></a></td>
                        </tr>
                      <?php } ?>
                    </tbody>
                  </table>
